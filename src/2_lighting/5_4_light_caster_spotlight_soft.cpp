...
int main(int argc, char* argv[]) {
    ...
    Shader cubeShader(
            "../../src/2_lighting/shaders/5_4_light_caster_spotlight_soft.vs",
            "../../src/2_lighting/shaders/5_4_light_caster_spotlight_soft.fs");

    Texture texture1("../../resources/textures/container2.png", GL_RGBA);
    Texture texture2("../../resources/textures/container2_specular.png", GL_RGBA);
