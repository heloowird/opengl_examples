...
void process_input(GLFWwindow *window, float &ratio)
{
...
int main(int argc, char* argv[]) {
    ...
    Shader shaderProgram = Shader(
            "../../test/1_getting_started/shaders/3_texture_excercise4.vs",
            "../../test/1_getting_started/shaders/3_texture_excercise4.fs");
    ...
    float ratio = 0.2;
    shaderProgram.setFloat("mixRatio", ratio);
    // 渲染loop
    while (!glfwWindowShouldClose(window))
    {
        // 处理输入
        process_input(window, ratio);
