...
******************************************************************/
#ifndef OPENGL_EXAMPLE_POST_PROCESSOR_H
#define OPENGL_EXAMPLE_POST_PROCESSOR_H
...
public:
    ...
    // Constructor
    PostProcessor(std::shared_ptr<Shader> shader, GLuint width, GLuint height);
...
#endif //OPENGL_EXAMPLE_POST_PROCESSOR_H
